...
\title{Economía Agraria y Rural en el Perú: Análisis de Desafíos y
Oportunidades}
...
\tableofcontents
\newpage
\section[Introduction]{Economía Agraria y Rural en el Perú}
...
\section{La industria y el campesino}\label{la-industria-y-el-campesino}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1218}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0897}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1410}}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1090}}
  >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1346}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0457}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1600}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1200}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1886}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1314}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1200}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2343}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0980}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0392}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1569}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1961}}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2020}}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1833}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1387}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0876}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0949}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1314}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1533}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1533}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1314}}
  >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1095}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\textbf{Tipo de terreno}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
