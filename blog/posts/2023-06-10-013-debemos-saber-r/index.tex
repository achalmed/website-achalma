...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, rightrule=.15mm, toptitle=1mm, left=2mm, coltitle=black, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, colback=white, leftrule=.75mm]
