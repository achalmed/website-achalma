...
## Envíame una nota {{< fa feather-pointed >}} {.lab-section}
...
También me encanta saber si mis materiales educativos te han resultado útiles y cómo podrían mejorarse, especialmente si pudieran hacerse más accesibles. {{< fa heart >}}
...
<form action="https://formspree.io/f/mgvananz" method="POST" accept-charset="utf-8">
...
## Una nota ocasional, sin ruido ni spam {{< fa envelope >}} {.lab-section}

::: {.grid}

::: {.g-col-12 .g-col-md-5 #buttondown}
...
::: {.g-col-12 .g-col-md-6 #buttondown-form}
...
## Agenda para reunirnos {{< fa solid calendar >}} {.lab-section}

```{=html}
<!-- Google Calendar Appointment Scheduling begin -->
<iframe src="https://calendar.google.com/calendar/appointments/schedules/AcZssZ0-fMJoBZQZOOppP8OOBVpWvwmdcy9md-nrXtKUfha_wpFHyEtZmiGE-wC77jcnpkxamfdHWDzc?gv=true" style="border: 0" width="100%" height="600" frameborder="0"></iframe>
