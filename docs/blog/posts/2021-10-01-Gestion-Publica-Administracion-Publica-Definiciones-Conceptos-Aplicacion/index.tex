...
\hypersetup{
  ...
  pdfauthor={Achalma Mendoza Elmer Edison; Bermdo HEREDIA Felix Manuel; BORDA TORRES Noe; CASTILLO LOPEZ Kattya Yasitrh; FERNANDEZ NÚÑEZ Yuri David},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\author{Achalma Mendoza Elmer Edison \and Bermdo HEREDIA Felix
Manuel \and BORDA TORRES Noe \and CASTILLO LOPEZ Kattya
Yasitrh \and FERNANDEZ NÚÑEZ Yuri David}
\date{10/1/21}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, sharp corners, breakable, enhanced, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
\section{Indagar definiciones, conceptos y aplicación de: gestión
...
*¿Cuál es la importancia de cada una de estas categorías en la gestión
gubernamental?**
...
\textbf{¿Cuál es el campo de aplicación de la gestión pública y la
administración pública?, señale casos y ejemplos.}
