...
\hypersetup{
  ...
  pdfauthor={ACHALMA MENDOZA Elmer Edison; BERMUDO HEREDIA Felix Manuel; BORDA TORRES Noe; CASTILLO LOPEZ Kattya Yasitrh; FERNANDEZ NÚÑEZ Yuri Davi},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
sociedad.}
\author{ACHALMA MENDOZA Elmer Edison \and BERMUDO HEREDIA Felix
Manuel \and BORDA TORRES Noe \and CASTILLO LOPEZ Kattya
Yasitrh \and FERNANDEZ NÚÑEZ Yuri Davi}
\date{10/1/21}
...
hacer?}}{¿Qué hacer?}}\label{quuxe9-hacer}}

\hypertarget{reformar-la-gestiuxf3n-puxfablica}{%
\subsection{\texorpdfstring{\textbf{¿Reformar la gestión
pública?}}{¿Reformar la gestión pública?}}\label{reformar-la-gestiuxf3n-puxfablica}}
...
\subsection{\texorpdfstring{\textbf{¿Reformar el
estado?}}{¿Reformar el estado?}}\label{reformar-el-estado}}
...
\subsubsection{\texorpdfstring{\textbf{Reforma
política}}{Reforma política}}\label{reforma-poluxedtica}}
...
\subsubsection{\texorpdfstring{\textbf{Reforma
económica}}{Reforma económica}}\label{reforma-econuxf3mica}}

Las empresas nacionales y extranjeras deben competir en igualdad de
condiciones.

\hypertarget{reforma-de-salud}{%
\subsubsection{\texorpdfstring{\textbf{Reforma de
salud}}{Reforma de salud}}\label{reforma-de-salud}}
...
\subsubsection{\texorpdfstring{\textbf{Reforma
agraria}}{Reforma agraria}}\label{reforma-agraria}}
...
\subsubsection{\texorpdfstring{\textbf{Reforma
tributaria}}{Reforma tributaria}}\label{reforma-tributaria}}
...
\subsection{\texorpdfstring{\textbf{¿Modernizar la gestión
pública?}}{¿Modernizar la gestión pública?}}\label{modernizar-la-gestiuxf3n-puxfablica}}
...
\subsection{\texorpdfstring{\textbf{¿Modernizar el
estado?}}{¿Modernizar el estado?}}\label{modernizar-el-estado}}
...
\subsection{\texorpdfstring{\textbf{¿Reformar y modernizar la gestión
pública?}}{¿Reformar y modernizar la gestión pública?}}\label{reformar-y-modernizar-la-gestiuxf3n-puxfablica}}
