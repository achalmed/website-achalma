---
title: Economía de los Recursos y del Medio Ambiente
subtitle: Una 
description: |
  De
categories:
...
author: 
  ...
  - Fernández Pujaico Anais Marina
  - Gamboa Rua Brenda Tehalí
  - Gómezz Ayala Margoth Rossio
crossref: 
  fig-title: Figura
  fig-prefix: Figura
  tbl-title: Tabla
...
_Variables e indicadores del modelo de economía circular_
...
A mayor cantidad de prácticas agrícolas insostenibles, se genera una mayor pérdida de diversidad.
...
![Prueba de normalidad del precio del Gas natural](20230603091227.png){#fig-7}
...
![Hanno](20230603091845.png){#fig-10.2}
...
La Tabla 1 muestra los resultados de la regresión entre el precio del petróleo y el precio del gas.

![Tabla 1: Regresión de precio de petróleo y precio del gas](20230603100307.png)
