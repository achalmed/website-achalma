...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, bottomtitle=1mm, arc=.35mm, left=2mm, toptitle=1mm, leftrule=.75mm, opacityback=0, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, colback=white]
