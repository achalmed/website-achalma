...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, breakable, colframe=quarto-callout-note-color-frame, toptitle=1mm, toprule=.15mm, rightrule=.15mm, colback=white, coltitle=black, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, leftrule=.75mm, arc=.35mm, opacityback=0, bottomrule=.15mm]
