...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, breakable, borderline west={3pt}{0pt}{shadecolor}, enhanced, frame hidden, interior hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, leftrule=.75mm, opacityback=0, toptitle=1mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, arc=.35mm, titlerule=0mm, coltitle=black, bottomrule=.15mm, left=2mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame]
