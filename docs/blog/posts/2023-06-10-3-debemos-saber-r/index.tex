...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, breakable, borderline west={3pt}{0pt}{shadecolor}, frame hidden, boxrule=0pt, interior hidden, sharp corners]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, coltitle=black, leftrule=.75mm, colback=white, toptitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0]
