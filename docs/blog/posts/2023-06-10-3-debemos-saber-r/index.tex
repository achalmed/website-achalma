...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, arc=.35mm, opacityback=0, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, opacitybacktitle=0.6, coltitle=black, rightrule=.15mm, bottomrule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm]
