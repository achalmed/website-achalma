...
Estas fórmulas nos permite calcular la magnitud de la respuesta de la
demanda ante cambios en el precio. Si la elasticidad es mayor a 1, se
considera que la demanda es elástica, lo que implica que los
consumidores son sensibles al cambio de precio y una variación en el
precio provocará un cambio proporcionalmente mayor en la cantidad
demandada. Por otro lado, si la elasticidad es menor a 1, se considera
que la demanda es inelástica, lo que indica que los consumidores son
menos sensibles al cambio de precio y una variación en el precio tendrá
