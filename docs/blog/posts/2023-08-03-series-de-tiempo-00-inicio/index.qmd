...
```{r}
#| echo: false  # No mostrar comandos ejecutados
...
```{r}
#| label: fig-fig1
#| fig-cap: "Indicador Global de Actividad Económica (IGAE) Global y para las Actividades Primarias (2008=100), Ene.2002 - May.2021"
#| fig-alt: "Indicador Global de Actividad Económica (IGAE) Global y para las Actividades Primarias (2008=100), Ene.2002 - May.2021"
...
```{r}
#| label: fig-fig2
#| fig-cap: "índice de Confianza del Consumidor (ICC): General y resultado de ¿Cómo considera usted la situación economica del país hoy en día comparada con la de hace 12 meses? (puntos), Ene.2002-may.2021"
...
```{r}
#| label: fig-fig3
#| fig-cap: "índice de Precios y Cotizaciones de la Bolsa Mexicana de Valores (Panel Derecho) y Tipo de Cambio para Solventar Obligaciones en Moneda Extranjera, pesos por dólar (Panel izquierdo), Ene.2002-May.2021"
#| fig-subcap: 
#|   - "Indice de Precios y Cotizaciones BMV"
#|   - "Tipo de Cambio"
#| layout-ncol: 2
...
```{r}
#| label: fig-fig4
#| fig-cap: "Índice del índice de Precios y Cotizaciones de la Bolsa Mexicana de Valores (Panel Derecho) e Índice del Tipo de Cambio para Solventar Obligaciones en Moneda Extranjera (ambos enero de 2002 = 100), pesos por dólar (Panel izquierdo), Ene.2002-May.2021"
...
```{r}
#| label: fig-fig5
#| fig-cap: "Tasas de Crecimiento mensuales (diferencias logarítmicas) de Indicador Global de la Actividad Económica, Índice de Precios y Cotizaciones de la Bolsa Mexicana de Valores (Panel Derecho) y Tipo de Cambio para Solventar Obligaciones en Moneda Extranjera, Ene.2002-May.2021"
#| fig-subcap: 
#|   - "Indicador Global de la Actividad Economica"
#|   - "Indice de Precios y Cotizaciones BMV"
#|   - "Tipo de Cambio"
#| layout-nrow: 3
