...
#| label: tbl-table1
#| tbl-cap: "Dos ejemplos de Procesos de Ecuaciones Lineales de Primer Orden Convergentes"
...
```{r message=FALSE, results='asis'}
#| label: tbl-table2
#| tbl-cap: "Un ejemplo de proceso de Ecuación de Segundo Orden convengente"
