...
\hypersetup{
  pdftitle={Visualización de datos en macroeconomía con python},
...
\title{Visualización de datos en macroeconomía con python}
\usepackage{etoolbox}
\makeatletter
...
comprender las tendencias y relaciones en la macroeconomia.}
\author{Edison Achalma}
\date{2023-07-04}

\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, interior hidden, enhanced, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Introducción a la visualización de datos en macroeconomía

  \begin{itemize}
  \tightlist
  \item
    Importancia de la visualización de datos en el análisis
    macroeconómico
  \item
    Beneficios de utilizar gráficos en la interpretación de datos en
    macroeconomía
  \item
    Introducción a las bibliotecas y herramientas utilizadas en la
    visualización de datos en macroeconomía
  \end{itemize}
\item
  Gráficos de variables macroeconómicas clave

  \begin{itemize}
  \tightlist
  \item
    Visualización de variables macroeconómicas como el PIB, la
    inflación, el desempleo, etc.
  \item
    Utilización de gráficos para analizar tendencias, ciclos económicos
...
\item
  ...
  \tightlist
  \item
    Representación gráfica de series de tiempo de variables
    macroeconómicas
  \item
    Utilización de gráficos de series de tiempo para identificar
    patrones, estacionalidad y tendencias
  \item
    Ejemplos prácticos de visualización de datos de series de tiempo en
    macroeconomía
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Utilización de gráficos para analizar el impacto de políticas
    económicas en variables macroeconómicas
  \item
    Visualización de datos para evaluar el efecto de cambios en la
    política monetaria, fiscal, etc.
  \item
    Ejemplos prácticos de visualización de datos en el análisis de
    políticas económicas
  \end{itemize}
\item
  Modelos econométricos y gráficos

  \begin{itemize}
  \tightlist
  \item
    Visualización de resultados de modelos econométricos utilizando
    gráficos
  \item
    Utilización de gráficos para representar relaciones de causalidad,
    elasticidades, etc.
  \item
    Ejemplos prácticos de visualización de datos en modelos
    econométricos en macroeconomía
  \end{itemize}
\item
  Visualización interactiva de datos en macroeconomía

  \begin{itemize}
  \tightlist
  \item
    Utilización de bibliotecas como Plotly y Bokeh para crear gráficos
    interactivos en el análisis macroeconómico
  \item
    Incorporación de herramientas interactivas como zoom, selección y
    filtros en gráficos de macroeconomía
  \item
    Ejemplos prácticos de visualización interactiva de datos en
    macroeconomía
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Aplicación de la visualización de datos en macroeconomía en
    diferentes escenarios, como análisis de políticas, pronósticos
    económicos, etc.
  \item
    Ejemplos de visualización de datos en macroeconomía en situaciones
    reales
  \end{itemize}
\item
  ...
  \tightlist
  \item
    Resumen de las técnicas y mejores prácticas en la visualización de
    datos en el campo de la macroeconomía
  \item
    Recursos adicionales para aprender más sobre la visualización de
    datos en el campo de la macroeconomía
  \end{itemize}
\end{enumerate}
