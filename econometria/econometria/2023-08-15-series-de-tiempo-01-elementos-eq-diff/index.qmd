---
title: Elementos de Ecuaciones en Diferencia
subtitle: Entendiendo las ecuaciones en diferencias para modelar series de tiempo.
description: |
  Conceptos básicos de ecuaciones en diferencias y su aplicación en series de tiempo
categories:
  - Estadística
  - Matemáticas
  - Series de tiempo
...
#| warning: FALSE
#| results: 'asis'
#| fig-cap: "Evolución del proceso dado por $Z_t =2+0.9Z_{t-1}$"
#| fig-align: 'center'
#| fig-height: 3.5
...
#| warning: FALSE
#| results: 'asis'
#| fig-cap: "Evolución del proceso dado por $Z_t =2-0.5Z_{t-1}$"
#| fig-align: 'center'
#| fig-height: 3.5
...
#| warning: FALSE
#| results: 'asis'
#| fig-cap: "Evolución del proceso dado por $Z_t =3+0.9Z_{t-1}-0.2Z_{t-2}$"
#| fig-align: 'center'
#| fig-height: 3.5
...
```{r}
#| label: fig24
#| fig-cap: "Circulo unitario en el que se cumple que $|g_i|<1$ y $(g_i g_j)^{1/2} = (u^2 + v^2)^{1/2} < 1$"
#| echo: TRUE
#| fig-height: 4.5
#| fig-width: 4
#| message: FALSE
