...
\textless!--\# MEDICION DE LA ESTRUCTURA Y DESEMPEÑO DE LA ORGANIZACIÓN
INDUSTRIAL
...
recíproco del número de empresas (\(\frac{1}{n}\)):

\begin{itemize}
\item
  Sí \(\frac{1}{n}\)→0 \ldots.. El mercado tiene una estructura de
  ``competencia perfecta''
\item
  \(\frac{1}{n}\) = 1 \ldots.. El mercado tiene una estructura de
  ``monopolio''
\item
  Sí 0 \textless{} \(\frac{1}{n}\) \textless{} 0,5 \ldots. Puede ser
  competencia monopolística
\item
  Sí 0.50 ≤ \(\frac{1}{n}\) \textless{} 1, \ldots{} Entonces tiene la
...
vale \(\frac{1}{n}\) y en el segundo vale 1.
...
alta. Por el contrario si ∝ tiende a cero (0) entonces el IHK =
(\(\frac{1}{n}\)), en este caso todas las empresas son iguales. En
cambio, si IHK tiende al infinito, entonces el grado de concentración es
igual a su cuota de participación (si).
