...
\title{Técnicas de Validación Cruzada y Composición de Modelos:
Evaluación y Optimización en Aprendizaje Automático}
...
\tableofcontents
\newpage
\section[Introduction]{Técnicas de Validación Cruzada y Composición de
Modelos}
