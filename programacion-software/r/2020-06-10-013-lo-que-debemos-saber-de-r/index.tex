...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, left=2mm, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colback=white, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, arc=.35mm, breakable, opacityback=0, coltitle=black, opacitybacktitle=0.6]
