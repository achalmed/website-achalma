...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacitybacktitle=0.6, arc=.35mm, toprule=.15mm, left=2mm, titlerule=0mm, bottomtitle=1mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, opacityback=0, rightrule=.15mm, toptitle=1mm, bottomrule=.15mm, coltitle=black]
