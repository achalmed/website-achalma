...
blog_root = '../econometria'  # Ajusta esta ruta según tu estructura 'ruta/a/tu/carpeta/de/blog'
        ...
        for folder in os.listdir(subblog_path):
            ...
            if os.path.isdir(folder_path):
                ...
                if os.path.exists(qmd_file):
                    ...
                    updated_content = re.sub(r'categories:.*', f'categories:\n  - {subblog_name}', content)
